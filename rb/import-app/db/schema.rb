...
ActiveRecord::Schema.define(version: 20171112034121) do
  ...
  add_foreign_key "operation_categories", "categories", name: "operation_categories_category_id_fkey"
  add_foreign_key "operation_categories", "operations", name: "operation_categories_operation_id_fkey"
end
